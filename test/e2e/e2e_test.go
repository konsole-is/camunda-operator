...
const namespace = "camunda-operator-system"

// serviceAccountName created for the project
const serviceAccountName = "camunda-operator-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "camunda-operator-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "camunda-operator-metrics-binding"

var _ = Describe("Manager", Ordered, Label(utils.LabelManager), func() {
	var controllerPodName string

	// The suite deploys the controller-manager. This container only cleans
	// up what its own specs create.
	AfterAll(func() {
	...
	Context("Manager", func() {
		...
		It("should ensure the metrics endpoint is serving metrics", func() {
			...
			verifyControllerPodReady := func(g Gomega) {
				cmd := exec.Command(
					"kubectl", "get", "pod", controllerPodName, "-n", namespace,
...
func serviceAccountToken() (string, error) {
	...
	verifyTokenCreation := func(g Gomega) {
		...
		cmd := exec.Command(
			"kubectl", "create", "--raw", fmt.Sprintf(
