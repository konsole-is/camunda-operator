...
*/}}
{{- define "camunda-operator.fullname" -}}
...
*/}}
{{- define "camunda-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "camunda-operator.resourceName" -}}
{{- $fullname := include "camunda-operator.fullname" .context }}
{{- $suffix := .suffix }}
