...
// retryInterval is long on purpose. A hold that resolves inside the test
// timeout therefore proves that a watch woke the restore, and not the timer.
...
func TestLogicalRestoreController(t *testing.T) {
	RegisterFailHandler(Fail)

	RunSpecs(t, "LogicalRestore Controller Suite")
}
