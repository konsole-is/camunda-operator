...
func TestDatabaseControllers(t *testing.T) {
	RegisterFailHandler(Fail)

	RunSpecs(t, "Database Controller Suite")
}

// The DatabaseServerConfig and DatabaseConfig controllers are deliberately
// absent. The Database reconciler resolves and connects to the referenced
// server itself and does not wait on the Ready condition of either contract.
// Its specs therefore only need the objects to exist.
