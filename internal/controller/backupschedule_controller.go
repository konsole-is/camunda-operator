...
// +kubebuilder:rbac:groups=core.camunda.io,resources=backupschedules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=core.camunda.io,resources=backupschedules/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=core.camunda.io,resources=backupschedules/finalizers,verbs=update
