...
// CamundaOptimizeSpec defines the desired state of CamundaOptimize
type CamundaOptimizeSpec struct {
	...
	// foo is an example field of CamundaOptimize. Edit camundaoptimize_types.go to remove/update
	// +optional
	Foo *string `json:"foo,omitempty"`
}

// CamundaOptimizeStatus defines the observed state of CamundaOptimize.
type CamundaOptimizeStatus struct {
	...
	// conditions represent the current state of the CamundaOptimize resource.
...
// CamundaOptimize is the Schema for the camundaoptimizes API
