...
type DatabaseStatus struct {
	...
	// CollisionKey is the claim of this Database: the system identifier of
	// the server and the logical database name. The operator records it once
	// it resolves the server. One logical database on one server has one
	// owner across all namespaces, and the first Database to claim it owns
	// it. The operator never clears the field, so a Database whose server or
	// contract is gone keeps the logical database. Delete such a Database to
	// release it.
	// +optional
