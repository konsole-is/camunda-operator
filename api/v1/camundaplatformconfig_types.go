...
// CamundaPlatformConfigSpec defines the desired state of CamundaPlatformConfig
type CamundaPlatformConfigSpec struct {
	...
	// foo is an example field of CamundaPlatformConfig. Edit camundaplatformconfig_types.go to remove/update
	// +optional
	Foo *string `json:"foo,omitempty"`
}

// CamundaPlatformConfigStatus defines the observed state of CamundaPlatformConfig.
type CamundaPlatformConfigStatus struct {
	...
	// conditions represent the current state of the CamundaPlatformConfig resource.
...
// CamundaPlatformConfig is the Schema for the camundaplatformconfigs API
