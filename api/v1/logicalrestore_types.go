...
// LogicalRestoreSpec defines the desired state of LogicalRestore
type LogicalRestoreSpec struct {
	...
	// foo is an example field of LogicalRestore. Edit logicalrestore_types.go to remove/update
	// +optional
...
type LogicalRestoreStatus struct {
	...
	// conditions represent the current state of the LogicalRestore resource.
...
// LogicalRestore is the Schema for the logicalrestores API
