...
- Suspend: the suspend mutation sets `spec.instances = 0`; CloudNativePG scales the pods away and keeps the PVCs. The delete-on-suspend decision is never.
