...
| #370 | fix/suspend-only-for-shared-backends--keep-workloads-on-precheck-failure | .claude/worktrees/suspend-only-for-shared-backends/.claude/worktrees/keep-workloads-on-precheck-failure | #371 → fix/suspend-only-for-shared-backends | at 6ef0ca8, five final-review items with the agent (stale message after a suspension ends, shared scale-and-stage helper, ConditionTypeFor), Copilot round 16 after; merges second |
