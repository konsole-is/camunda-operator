...
// Resource is a high-level abstraction for managing Cluster objects within a
...
type Resource struct {
	base *generic.WorkloadResource[*cnpgv1.Cluster, *Mutator]
}

// Identity returns a unique identifier for the Cluster in the format
// "postgresql.cnpg.io/v1/Cluster/<namespace>/<name>".
func (r *Resource) Identity() string {
	return r.base.Identity()
}

// Object returns a deep copy of the underlying Cluster object.
//
...
// Mutate transforms the current state of the Cluster into the desired state.
//
...
// ConvergingStatus evaluates whether the Cluster has reached its converged state.
//
...
// GraceStatus provides a health assessment of the Cluster once the component's
...
// DeleteOnSuspend determines whether the Cluster is deleted from the cluster when
...
// Suspend triggers the deactivation of the Cluster.
//
...
// component to read generated or updated values from the Cluster.
func (r *Resource) ExtractData() error {
	return r.base.ExtractData()
}

// ProducedData returns the cells this Cluster declares extractions into.
...
// ConsumedData returns the Cluster's declared data reads. It satisfies
...
// Preview renders the Cluster as a client.Object with feature mutations applied,
...
// the Cluster, independent of version. It satisfies concepts.MutationInspector so
...
// version the Cluster was built at. It satisfies concepts.MutationInspector.
