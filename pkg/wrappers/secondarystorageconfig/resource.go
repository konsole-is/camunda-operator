...
// Resource is a high-level abstraction for managing SecondaryStorageConfig objects within a
...
type Resource struct {
	base *generic.StaticResource[*apiv1.SecondaryStorageConfig, *Mutator]
}

// Identity returns a unique identifier for the SecondaryStorageConfig in the format
// "core.camunda.io/v1/SecondaryStorageConfig/<namespace>/<name>".
func (r *Resource) Identity() string {
	return r.base.Identity()
}

// Object returns a deep copy of the underlying SecondaryStorageConfig object.
//
...
// Mutate transforms the current state of the SecondaryStorageConfig into the desired state.
//
...
// reconciled SecondaryStorageConfig.
//
// This is called by the framework after successful reconciliation, allowing the
// component to read generated or updated values from the SecondaryStorageConfig.
func (r *Resource) ExtractData() error {
	return r.base.ExtractData()
}

// ProducedData returns the cells this SecondaryStorageConfig declares extractions into.
...
// ConsumedData returns the SecondaryStorageConfig's declared data reads. It satisfies
...
// Preview renders the SecondaryStorageConfig as a client.Object with feature mutations applied,
...
// the SecondaryStorageConfig, independent of version. It satisfies concepts.MutationInspector so
...
// version the SecondaryStorageConfig was built at. It satisfies concepts.MutationInspector.
