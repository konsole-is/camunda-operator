...
// testObject returns a valid namespaced SecondaryStorageConfig fixture.
func testObject() *apiv1.SecondaryStorageConfig {
	return &apiv1.SecondaryStorageConfig{
...
func TestBuilderBuildValidation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assert.Equal(t, "core.camunda.io/v1/SecondaryStorageConfig/test-ns/test-object", res.Identity())
		})
	}
}
...
func TestExtractIntoDeclaredExtraction(t *testing.T) {
	...
	cell := concepts.NewData[string]("secondarystorageconfig-name")
	builder := NewBuilder(testObject())
	ExtractInto(builder, cell, func(o apiv1.SecondaryStorageConfig) (string, error) {
		return o.Name, nil
	})
	...
	assert.Equal(t, "secondarystorageconfig-name", produced[0].Name())
