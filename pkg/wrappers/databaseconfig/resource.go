...
// Resource is a high-level abstraction for managing DatabaseConfig objects within a
...
type Resource struct {
	base *generic.StaticResource[*apiv1.DatabaseConfig, *Mutator]
}

// Identity returns a unique identifier for the DatabaseConfig in the format
// "core.camunda.io/v1/DatabaseConfig/<namespace>/<name>".
func (r *Resource) Identity() string {
	return r.base.Identity()
}

// Object returns a deep copy of the underlying DatabaseConfig object.
//
...
// Mutate transforms the current state of the DatabaseConfig into the desired state.
//
...
// reconciled DatabaseConfig.
//
// This is called by the framework after successful reconciliation, allowing the
// component to read generated or updated values from the DatabaseConfig.
func (r *Resource) ExtractData() error {
	return r.base.ExtractData()
}

// ProducedData returns the cells this DatabaseConfig declares extractions into.
...
// ConsumedData returns the DatabaseConfig's declared data reads. It satisfies
...
// Preview renders the DatabaseConfig as a client.Object with feature mutations applied,
...
// the DatabaseConfig, independent of version. It satisfies concepts.MutationInspector so
...
// version the DatabaseConfig was built at. It satisfies concepts.MutationInspector.
