...
// Resource is a high-level abstraction for managing PodMonitor objects within a
...
type Resource struct {
	base *generic.StaticResource[*monitoringv1.PodMonitor, *Mutator]
}

// Identity returns a unique identifier for the PodMonitor in the format
// "monitoring.coreos.com/v1/PodMonitor/<namespace>/<name>".
func (r *Resource) Identity() string {
	return r.base.Identity()
}

// Object returns a deep copy of the underlying PodMonitor object.
//
...
// Mutate transforms the current state of the PodMonitor into the desired state.
//
...
// reconciled PodMonitor.
//
// This is called by the framework after successful reconciliation, allowing the
// component to read generated or updated values from the PodMonitor.
func (r *Resource) ExtractData() error {
	return r.base.ExtractData()
}

// ProducedData returns the cells this PodMonitor declares extractions into.
...
// ConsumedData returns the PodMonitor's declared data reads. It satisfies
...
// Preview renders the PodMonitor as a client.Object with feature mutations applied,
...
// the PodMonitor, independent of version. It satisfies concepts.MutationInspector so
...
// version the PodMonitor was built at. It satisfies concepts.MutationInspector.
