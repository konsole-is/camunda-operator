...
// Resource is a high-level abstraction for managing ServiceMonitor objects within a
...
type Resource struct {
	base *generic.StaticResource[*monitoringv1.ServiceMonitor, *Mutator]
}

// Identity returns a unique identifier for the ServiceMonitor in the format
// "monitoring.coreos.com/v1/ServiceMonitor/<namespace>/<name>".
func (r *Resource) Identity() string {
	return r.base.Identity()
}

// Object returns a deep copy of the underlying ServiceMonitor object.
//
...
// Mutate transforms the current state of the ServiceMonitor into the desired state.
//
...
// reconciled ServiceMonitor.
//
// This is called by the framework after successful reconciliation, allowing the
// component to read generated or updated values from the ServiceMonitor.
func (r *Resource) ExtractData() error {
	return r.base.ExtractData()
}

// ProducedData returns the cells this ServiceMonitor declares extractions into.
...
// ConsumedData returns the ServiceMonitor's declared data reads. It satisfies
...
// Preview renders the ServiceMonitor as a client.Object with feature mutations applied,
...
// the ServiceMonitor, independent of version. It satisfies concepts.MutationInspector so
...
// version the ServiceMonitor was built at. It satisfies concepts.MutationInspector.
