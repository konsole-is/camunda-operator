...
// Resource is a high-level abstraction for managing Elasticsearch objects within a
...
type Resource struct {
	base *generic.WorkloadResource[*elasticsearchv1.Elasticsearch, *Mutator]
}

// Identity returns a unique identifier for the Elasticsearch in the format
// "elasticsearch.k8s.elastic.co/v1/Elasticsearch/<namespace>/<name>".
func (r *Resource) Identity() string {
	return r.base.Identity()
}

// Object returns a deep copy of the underlying Elasticsearch object.
//
...
// Mutate transforms the current state of the Elasticsearch into the desired state.
//
...
// ConvergingStatus evaluates whether the Elasticsearch has reached its converged state.
//
// By default it uses DefaultConvergingStatusHandler. The return value carries a status and
...
// GraceStatus provides a health assessment of the Elasticsearch once the component's
...
// DeleteOnSuspend determines whether the Elasticsearch is deleted from the cluster when
...
// Suspend triggers the deactivation of the Elasticsearch.
//
...
// reconciled Elasticsearch.
//
// This is called by the framework after successful reconciliation, allowing the
// component to read generated or updated values from the Elasticsearch.
func (r *Resource) ExtractData() error {
	return r.base.ExtractData()
}

// ProducedData returns the cells this Elasticsearch declares extractions into.
...
// ConsumedData returns the Elasticsearch's declared data reads. It satisfies
...
// Preview renders the Elasticsearch as a client.Object with feature mutations applied,
...
// the Elasticsearch, independent of version. It satisfies concepts.MutationInspector so
...
// version the Elasticsearch was built at. It satisfies concepts.MutationInspector.
