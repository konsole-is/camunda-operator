...
// Resource is a high-level abstraction for managing DatabaseServerConfig objects within a
...
type Resource struct {
	base *generic.StaticResource[*apiv1.DatabaseServerConfig, *Mutator]
}

// Identity returns a unique identifier for the DatabaseServerConfig in the format
// "core.camunda.io/v1/DatabaseServerConfig/<namespace>/<name>".
func (r *Resource) Identity() string {
	return r.base.Identity()
}

// Object returns a deep copy of the underlying DatabaseServerConfig object.
//
...
// Mutate transforms the current state of the DatabaseServerConfig into the desired state.
//
...
// reconciled DatabaseServerConfig.
//
// This is called by the framework after successful reconciliation, allowing the
// component to read generated or updated values from the DatabaseServerConfig.
func (r *Resource) ExtractData() error {
	return r.base.ExtractData()
}

// ProducedData returns the cells this DatabaseServerConfig declares extractions into.
...
// ConsumedData returns the DatabaseServerConfig's declared data reads. It satisfies
...
// Preview renders the DatabaseServerConfig as a client.Object with feature mutations applied,
...
// the DatabaseServerConfig, independent of version. It satisfies concepts.MutationInspector so
...
// version the DatabaseServerConfig was built at. It satisfies concepts.MutationInspector.
