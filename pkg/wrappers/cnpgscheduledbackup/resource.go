...
// Resource is a high-level abstraction for managing ScheduledBackup objects within a
...
type Resource struct {
	base *generic.StaticResource[*cnpgv1.ScheduledBackup, *Mutator]
}

// Identity returns a unique identifier for the ScheduledBackup in the format
// "postgresql.cnpg.io/v1/ScheduledBackup/<namespace>/<name>".
func (r *Resource) Identity() string {
	return r.base.Identity()
}

// Object returns a deep copy of the underlying ScheduledBackup object.
//
...
// Mutate transforms the current state of the ScheduledBackup into the desired state.
//
...
// reconciled ScheduledBackup.
//
// This is called by the framework after successful reconciliation, allowing the
// component to read generated or updated values from the ScheduledBackup.
func (r *Resource) ExtractData() error {
	return r.base.ExtractData()
}

// ProducedData returns the cells this ScheduledBackup declares extractions into.
...
// ConsumedData returns the ScheduledBackup's declared data reads. It satisfies
...
// Preview renders the ScheduledBackup as a client.Object with feature mutations applied,
...
// the ScheduledBackup, independent of version. It satisfies concepts.MutationInspector so
...
// version the ScheduledBackup was built at. It satisfies concepts.MutationInspector.
