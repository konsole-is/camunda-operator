...
// Resource is a high-level abstraction for managing Keycloak objects within a
...
type Resource struct {
	base *generic.WorkloadResource[*Keycloak, *Mutator]
}

// Identity returns a unique identifier for the Keycloak in the format
// "k8s.keycloak.org/v2alpha1/Keycloak/<namespace>/<name>".
func (r *Resource) Identity() string {
	return r.base.Identity()
}

// Object returns a deep copy of the underlying Keycloak object.
//
...
// Mutate transforms the current state of the Keycloak into the desired state.
//
...
// ConvergingStatus evaluates whether the Keycloak has reached its converged state.
//
...
// GraceStatus provides a health assessment of the Keycloak once the component's
...
// DeleteOnSuspend determines whether the Keycloak is deleted from the cluster when
...
// Suspend triggers the deactivation of the Keycloak.
//
...
// component to read generated or updated values from the Keycloak.
func (r *Resource) ExtractData() error {
	return r.base.ExtractData()
}

// ProducedData returns the cells this Keycloak declares extractions into.
...
// ConsumedData returns the Keycloak's declared data reads. It satisfies
...
// Preview renders the Keycloak as a client.Object with feature mutations applied,
...
// the Keycloak, independent of version. It satisfies concepts.MutationInspector so
...
// version the Keycloak was built at. It satisfies concepts.MutationInspector.
