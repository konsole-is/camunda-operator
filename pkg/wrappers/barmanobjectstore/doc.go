...
// barmancloud.cnpg.io/v1, and the ocf primitive that reconciles it. The
// plugin publishes its Go module together with the CloudNativePG operator and
// cert-manager, so the types here are copied from the CRD instead. The schema
