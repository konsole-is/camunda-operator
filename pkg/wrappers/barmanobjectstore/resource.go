...
// Resource is a high-level abstraction for managing ObjectStore objects within a
...
type Resource struct {
	base *generic.StaticResource[*ObjectStore, *Mutator]
}

// Identity returns a unique identifier for the ObjectStore in the format
// "barmancloud.cnpg.io/v1/ObjectStore/<namespace>/<name>".
func (r *Resource) Identity() string {
	return r.base.Identity()
}

// Object returns a deep copy of the underlying ObjectStore object.
//
...
// Mutate transforms the current state of the ObjectStore into the desired state.
//
...
// component to read generated or updated values from the ObjectStore.
func (r *Resource) ExtractData() error {
	return r.base.ExtractData()
}

// ProducedData returns the cells this ObjectStore declares extractions into.
...
// ConsumedData returns the ObjectStore's declared data reads. It satisfies
...
// Preview renders the ObjectStore as a client.Object with feature mutations applied,
...
// the ObjectStore, independent of version. It satisfies concepts.MutationInspector so
...
// version the ObjectStore was built at. It satisfies concepts.MutationInspector.
