...
// shared bucket, and RepositoryName carries the same namespace and name, so
// the prefix is the one that RepositoryBasePath reads back out of the
// registered name. The credentials are not part of it: they reach the nodes
