...
// go test ./pkg/components/logicalrestorerdbms/ -run Golden -update-golden
...
func restore() *v1.LogicalRestoreRDBMS {
...
func TestBuildJobCarriesTheOwnerLabelsAndTheUID(t *testing.T) {
	...
	want := map[string]string{
		labels.LogicalRestoreRDBMSKey: "my-cluster-restore",
